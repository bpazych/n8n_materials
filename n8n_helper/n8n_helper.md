...
At this moment n8n can't automatically find related sub-workflow, so after import all required flows from json - you need in main workflow goto sub-wokflow node and manually select target sub-workflow in drop down menu (of course you need first import sub-workflow in same way as main flow)
